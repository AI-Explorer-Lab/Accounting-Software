...
class ExecutionPolicy:
        ...
        return tuple(
            dict.fromkeys(
                (
                    ...
                    str(self.control_repo_root / "frontend/node_modules"),
                    str(self.control_repo_root / "orchestrator/node_modules"),
                    str(
    ...
    def _runtime_read_paths(self) -> tuple[Path, ...]:
        ...
        candidates: list[Path] = [
            self.control_repo_root / "frontend/node_modules",
            self.control_repo_root / "orchestrator/node_modules",
            self.control_repo_root / "orchestrator/frontend/node_modules",
