...
from orchestrator.codex_loop.audit import AuditRecorder, file_sha256
from orchestrator.codex_loop.models import InfrastructureError, ReviewStatus, TaskSpec
from orchestrator.codex_loop.policy import ExecutionPolicy
...
from orchestrator.codex_loop.workspace import WorkspaceInfo, WorkspaceManager
...
def test_policy_runtime_copies_only_login_material_into_task_home(
    ...
    dependency_entries = (
        ...
        repository / "frontend/node_modules/.tmp",
        repository / "orchestrator/node_modules/@openai",
        repository / "orchestrator/frontend/node_modules/vitest",
    )
